...
def create_default_hyperparams():
    ...
    hyperparams = tf.contrib.training.HParams(
        ...
        data_src_vocab_size=50000,
        data_trg_vocab_size=50000,
        ...
        train_num_epoch=3,
        train_num_ckpt_to_keep=5,
        train_ckpt_output_dir="",
        train_summary_output_dir="",
        train_step_per_stat=10,
        train_step_per_ckpt=10000,
        train_step_per_eval=10000,
        train_clip_norm=5.0,
        ...
        model_encoder_encoding="context",
